...
export default {
  ...
  krauter_co: {
    ...
    text: 'Der <strong>Grundstein für ein langes, vitales Hundeleben</strong> ist eine gesunde Ernährung. Neben artgerechter Nahrung kann man für den Hund aber noch viel mehr tun. Alterserscheinungen, Stresssituationen oder Verdauungsprobleme, den Vierbeinern tut ein <strong>Vitamin-Mineralost von Mutter Natur</strong> gut. <br><br> Aus dem Grund gibt es die <strong>Naturkraft-Produkte von Reico</strong>. Diese Produkte wurden sorgfältig für die speziellen Problembereiche des Hundes zusammengemixt und dienen seinem Organismus der Gesunderhaltung genau wie der Genesung. Bei Reico finden gibt es genau das richtige Ergänzungsmittel für den Hund.',
  },
  menuList: {
    contactSite: 'Kontakt',
